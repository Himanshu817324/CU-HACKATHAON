...
import { Leaf, Globe, AlertCircle, Sparkles, TrendingUp, Zap } from 'lucide-react';
...
export default function GreenScorePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user) {
      setError('Please log in to analyze websites.');
      return;
    }
        ...
        <ScrollReveal variant="fadeInUp" className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-sm font-medium text-primary">Green Score Calculator</span>
            </motion.span>
            <motion.h1
            ...
            >
              Get instant insights into your website's environmental impact
            </motion.p>
          </div>
